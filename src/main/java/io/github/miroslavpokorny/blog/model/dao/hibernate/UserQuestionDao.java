...
@Repository
public class UserQuestionDao extends DaoBase<UserQuestion> implements io.github.miroslavpokorny.blog.model.dao.UserQuestionDao {
    private final UserDao userDao;

    @Autowired
    public UserQuestionDao(UserDao userDao) {
