...
import { ProfileInfoDto, LoadProfileAction } from "../api/ProfileControllerApi";
...
class ProfileEdit extends React.Component<ProfileEditProps> {
    ...
    constructor(props: ProfileEditProps) {
        ...
        if (State.loggedUser.id !== undefined) {
            LoadProfileAction(State.loggedUser.id, (error?: string | object, result?: ProfileInfoDto) => {
                if (error !== undefined) {
        ...
        return (
            <div className="container">
                <form>
                    ...
                    <FormGroup
                        validationState={
                            this.state.nickname ? Validation.notEmpty(this.state.nickname).toString() : "error"
                        }
                    >
